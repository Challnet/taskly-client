...
export default function Tasks() {
    ...
    const handleOrderBy = value => {
        ...
        const currentDirection = searchParams.get('orderDirection') || 'asc';
                        ...
                        <Tr>
                            <Th>
                                <Flex
                                    ...
                                    cursor='pointer'
                                    alignItems='center'>
                                    Task {searchParams.get('orderBy') === 'name' && (
                                        <BsArrowUp style={{ transform: searchParams.get('orderDirection') === 'desc' ? 'rotate(180deg)' : 'none' }} />
                                    )}
                                </Flex>
                            </Th>
                            <Th>
                                <Flex
                                    ...
                                    cursor='pointer'
                                    alignItems='center'>
                                    Task {searchParams.get('orderBy') === 'priority' && (
                                        <BsArrowUp style={{ transform: searchParams.get('orderDirection') === 'desc' ? 'rotate(180deg)' : 'none' }} />
                                    )}
                                </Flex>
                            </Th>
                            <Th>
                                <Flex
                                    ...
                                    cursor='pointer'
                                    alignItems='center'>
                                    Task {searchParams.get('orderBy') === 'status' && (
                                        <BsArrowUp style={{ transform: searchParams.get('orderDirection') === 'desc' ? 'rotate(180deg)' : 'none' }} />
                                    )}
                                </Flex>
                            </Th>
                            <Th>
                                <Flex
                                    ...
                                    cursor='pointer'
                                    alignItems='center'>
                                    Task {searchParams.get('orderBy') === 'due' && (
                                        <BsArrowUp style={{ transform: searchParams.get('orderDirection') === 'desc' ? 'rotate(180deg)' : 'none' }} />
                                    )}
                                </Flex>
                            </Th>
